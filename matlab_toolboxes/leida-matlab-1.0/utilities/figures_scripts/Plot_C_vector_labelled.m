...
switch parcellation
    ...
    case 'AAL120'
        ...
        clear label120
    case 'TVBSchaeferTian193'
        load('ParcelsMNI2mm','label193');
        labels = label193([1:n_areas],:);
        clear label193
    case 'TVBSchaeferTian218'
        load('ParcelsMNI2mm','label218');
        labels = label218([1:n_areas],:);
        clear label218
end
